...
public class Notice_college extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        wView = (WebView) v.findViewById(R.id.colleage_webView);
        pBar = v.findViewById(R.id.college_progressBar);    // 로딩바
    ...
    public void initWebView() {
        ...
        // 3. 웹페이지 호출
        wView.loadUrl("https://www.catholic.ac.kr/front/boardlist.do?cmsDirPkid=2053&cmsLocalPkid=2");
    }
    }

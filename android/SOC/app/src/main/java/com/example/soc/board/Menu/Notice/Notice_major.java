...
public class Notice_major extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        wView = (WebView) v.findViewById(R.id.major_webView);
        pBar = v.findViewById(R.id.major_progressBar);    // 로딩바
    ...
    public void initWebView() {
        ...
        // 3. 웹페이지 호출
        wView.loadUrl("https://ice.catholic.ac.kr/front/boardlist.do?cmsDirPkid=1032&cmsLocalPkid=0");
    }
}
